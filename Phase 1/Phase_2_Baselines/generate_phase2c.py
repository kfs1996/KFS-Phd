...
def suggest_1stage_model(trial, algo_name, y_train):
    ...
    if algo_name != 'NB': 
        # Adaptive Class Weight Tuning (Phase 2-C core concept)
        for cls in classes:
...
def run_phase2c(algo, embedding, dataset_name, X, y):
    ...
    return {
        ...
        'Phase 2-C (1-Stage Optuna)': best_acc
    }

class Phase2C_Generator:
    def __init__(self):
    ...
    def run(self):
        ...
        print(f"--- RUNNING PHASE 2-C AT MAX CAPACITY ({max_workers} CORES) ---")
        ...
        df_res.to_csv('FINAL_Phase2_C_All_Combinations.csv', index=False)
        print("Success! Phase 2-C Full Generated.")

if __name__ == "__main__":
    import multiprocessing
    multiprocessing.freeze_support()
    Phase2C_Generator().run()
